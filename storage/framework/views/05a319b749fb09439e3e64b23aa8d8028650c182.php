<?php /* /home/simplon/Bureau/laraginga/resources/views/auth/register.blade.php */ ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Confirmez votre mot de passe')); ?></label>
